...
func New(injector *do.Injector) (*ReleaseService, error) {
...
func (t *ReleaseService) buildTracks(err error, tracks []artistModels.Track, releaseArtists []artistModels.Artist) ([]artistModels.SlimTrack, error) {
	if err != nil {
...
func (t *ReleaseService) getPlatformReleaseUrls(err error, id int) ([]platformModels.PlatformReleaseUrl, error) {
	if err != nil {
